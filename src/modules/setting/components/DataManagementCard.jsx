      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm text-gray-600 font-medium">Chấm công</p>
              <p className="text-lg font-bold text-gray-900 leading-tight">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm text-gray-600 font-medium">Tổng lương</p>
              <p className="text-lg font-bold text-gray-900 leading-tight">
                {formatCurrency(dataStats.totalSalary)}đ
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm text-gray-600 font-medium">Nghỉ phép</p>
              <p className="text-lg font-bold text-gray-900 leading-tight">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm text-gray-600 font-medium">Tài liệu</p>
              <p className="text-lg font-bold text-gray-900 leading-tight">
        ...
        <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 bg-blue-50 rounded-lg border border-blue-200">
              <h4 className="text-sm font-medium text-blue-900 mb-3">Sao lưu dữ liệu</h4>
            ...
            <div className="p-6 bg-green-50 rounded-lg border border-green-200">
              <h4 className="text-sm font-medium text-green-900 mb-3">Khôi phục dữ liệu</h4>
