    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">
                {formatNumber(dataStats.totalEmployees)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-600">Chấm công</p>
              <p className="text-lg font-semibold text-gray-900">
                {formatNumber(dataStats.totalAttendance)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">
                {formatNumber(dataStats.totalSalary)}đ
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">
                {formatNumber(dataStats.totalLeave)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">
                {formatNumber(dataStats.totalDocuments)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              <h4 className="text-sm font-medium text-blue-900 mb-2">Sao lưu dữ liệu</h4>
              <p className="text-xs text-blue-700 mb-3">
                Tạo bản sao lưu toàn bộ dữ liệu hệ thống
              </p>
              <button className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 transition-colors">
                <Download className="w-4 h-4" />
                Tạo backup
              </button>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              <h4 className="text-sm font-medium text-green-900 mb-2">Khôi phục dữ liệu</h4>
              <p className="text-xs text-green-700 mb-3">
                Khôi phục dữ liệu từ file backup
              </p>
              <button className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-green-600 text-white text-sm rounded hover:bg-green-700 transition-colors">
            ...
            <div className="p-4 bg-red-50 rounded-lg border border-red-200">
              ...
              <button
                ...
                disabled={resetting}
                className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-red-600 text-white text-sm rounded hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {resetting ? (
                  <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
                ) : (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Xác nhận reset</h3>
            ...
            <div className="mb-6">
              <p className="text-sm text-gray-700 mb-3">
                Bạn có chắc chắn muốn reset toàn bộ dữ liệu demo? Hành động này sẽ:
              </p>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="text-sm font-medium text-blue-900">Lưu ý về quản lý dữ liệu</h4>
            <ul className="text-sm text-blue-700 mt-1 space-y-1">
              <li>• Luôn tạo backup trước khi thực hiện các thao tác quan trọng</li>
              <li>• Dữ liệu xuất sẽ bao gồm tất cả thông tin hiện tại</li>
              <li>• Reset demo sẽ xóa toàn bộ dữ liệu và không thể khôi phục</li>
